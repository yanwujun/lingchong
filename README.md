...
📖 **完整文档已迁移到 `docs/` 文件夹**  
👉 [查看文档索引](./docs/文档索引.md) - 50+ 个详细文档

### 主要文档
- 🚀 [快速开始指南](./docs/快速开始指南.md) - 新用户必读
- 📖 [v0.4.0使用指南](./docs/v0.4.0_使用指南.md) - 最新功能说明
- 🐛 [Bug修复报告](./docs/Bug修复报告_成就背包商店.md) - 最新修复
- 🎨 [动画系统文档](./docs/宠物动画系统完善报告.md) - 动画功能
- 📦 [打包说明](./docs/打包说明.md) - 应用打包指南
